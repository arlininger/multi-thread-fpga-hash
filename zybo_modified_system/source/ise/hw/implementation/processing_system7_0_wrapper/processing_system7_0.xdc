...
############################################################################
##  File name :       /home/arlininger/FPGA/ZYBO/zybo_modified_system/source/ise/hw/implementation/processing_system7_0_wrapper/processing_system7_0.xdc
##
...
# Clock constraints                                                        #
############################################################################
create_clock -name clk_fpga_2 -period "81.538" [get_nets "FCLK_CLK2"]
set_input_jitter clk_fpga_2 2.44614
create_clock -name clk_fpga_0 -period "10" [get_nets "FCLK_CLK0"]
set_input_jitter clk_fpga_0 0.3
create_clock -name clk_fpga_1 -period "5.714" [get_nets "FCLK_CLK1"]
set_input_jitter clk_fpga_1 0.17142
